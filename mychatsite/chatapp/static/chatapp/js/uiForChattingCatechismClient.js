...
//		+	'        				<img class="peopleCarouselImg" src="/static/chatapp/images/bible_cover.jpg"  alt="">'
//		+	'        				<div class="container">'
//		+	'        					<div class="carousel-caption" style="top: 0; bottom: auto;">'
		+	'        			        <blockquote>'
		+	'        			        <div class="row">'
		+	'        			            <div class="col-sm-8 col-sm-offset-2">'
		+	'        						<h5><a href="javascript:void(0);" onclick="callBibleVerses(\'' + bibleVerses[i] + '\'' + ',' + myCarousel + ');" style="color: #f4511e;"> <p>' + bibleVerses[i] + '</p> </a></h5>'
		+	'        						<p><span id="' + myCarousel + bibleVerses[i].replace(/\s/g,'') + '"></p>'
		+	'        			            </div>'
		+	'        			         </div>'
		+	'        			         </blockquote>'
//		+	'        					</div>' // 캡션종료
...
//		+	'        					<div class="carousel-caption" style="top: 0; bottom: auto;">'
		...
		+	'        			        <div class="row">'
		+	'        			            <div class="col-sm-8 col-sm-offset-2">'
		+	'        						<h5><a href="javascript:void(0);" onclick="callBibleVerses(\'' + bibleVerses[i] + '\'' + ',' + myCarousel + ');" style="color: #f4511e;">' + bibleVerses[i] + '</a></h5>'
		+	'        						<p><span id="' + myCarousel + bibleVerses[i].replace(/\s/g,'') + '"></p>'
		+	'        			            </div>'
		+	'        			         </div>'
		+	'        			         </blockquote>'
...
function callBibleVerses(bibleVerses, myCarousel) { //성경구절 내용 가져옴 
	var idName;
	idName = myCarousel + bibleVerses.replace(/\s/g,'');
